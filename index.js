...
console.log('task 6:', addArtist(artists, 'Mikhail Alviar', '2002-2022', 'Web Design', 'Filipino', 'I was bor in the Phillipines but raised in America. I am a small bundle of energy who enjoys being outside'));
...
function artistByCountry(artists, nationality){
  ...
  for (let i = 0; i < artists.length; i++){
    if (artists[i].nationality === nationality){
      artistsNationality.push(artists[i].name);
    }
  }
